...
STATIC_ROOT = os.path.join(ENV_PATH, "../public/static/") if not DEBUG else os.path.join(BASE_DIR, 'staticfiles')
MEDIA_ROOT = os.path.join(ENV_PATH, "../public/media/") if not DEBUG else os.path.join(BASE_DIR, 'media_cdn')
